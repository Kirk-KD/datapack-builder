  ...
  },
  {
    ...
    init(this: Blockly.Block) {
      this.appendValueInput(FIELD_VALUE)
        .setCheck([valueTypes.OptNumber, valueTypes.ProcParam])
      ...
      args0: [
        {
          ...
          check: [valueTypes.ProcParam, valueTypes.Number, valueTypes.Tilde, valueTypes.Caret]
        },
        {
          type: 'input_value',
          name: 'Y',
      ...
      args0: [
        {
          type: 'input_value',
          name: 'MIN',
          check: [valueTypes.ProcParam, valueTypes.Number]
        },
        {
          type: 'input_value',
          name: 'MAX',
  ...
  },
  {
    ...
    init(this: Blockly.Block) {
      this.appendValueInput(ROTATION_YAW_INPUT)
        .setCheck([valueTypes.ProcParam, valueTypes.Number, valueTypes.Tilde])
        .appendField('yaw')
